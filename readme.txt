...
= 1.2.1 (2025-10-16) =
* Resolved an issue in which the option object was initialized prematurely. [#4](https://github.com/iworks/wp-sitemap-control/issues/4) & [#5](https://github.com/iworks/wp-sitemap-control/issues/5). Props for [Katarzyna Janoska](https://github.com/anoriell).
...
= 1.1.1 (2025-03-12) =
* Added translation support to [GitHub releases](https://github.com/iworks/wp-sitemap-control/releases).
